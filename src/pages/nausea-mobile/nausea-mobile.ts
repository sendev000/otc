...
import { NauseaInfographicsMobilePage } from '../nausea-infographics-mobile/nausea-infographics-mobile';
...
export class NauseaMobilePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			StomachFluMobilePage,		// 1
  			FoodPoisoningMobilePage,	// 2
  			NauseaInfographicsMobilePage,	// 3
  		];
