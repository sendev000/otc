...
import { CommentCompareCyanPage } from '../comment-compare-cyan/comment-compare-cyan';

@Component({
  selector: 'page-heartburn-group',
  templateUrl: 'heartburn-group.html'
})
export class HeartburnGroupPage {
  ...
  showCommentCompare () {
    this.navCtrl.push(CommentCompareCyanPage);
  }
  showMenu() {
    this.menu.open();
  }
  ...
  initData() {
    ...
    this.RestApiURL = GlobalVars.getApiURL() + "page=heartburn_group";
    this.searchText = "";
    this.TableData = [];
    this.TableTempData = [];
