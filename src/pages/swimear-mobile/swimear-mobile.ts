...
import { SwimearInfographicsMobilePage } from '../swimear-infographics-mobile/swimear-infographics-mobile';

@Component({
  selector: 'page-swimear-mobile',
  templateUrl: 'swimear-mobile.html'
})
export class SwimearMobilePage {
...
@ViewChild(Content) content: Content;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			SwimearInfographicsMobilePage,	// 1
  		];
