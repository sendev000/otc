...
import { CankerSoreInfographicsMobilePage } from '../canker-sore-infographics-mobile/canker-sore-infographics-mobile';

@Component({
  selector: 'page-canker-sore-mobile',
  templateUrl: 'canker-sore-mobile.html'
})
export class CankerSoreMobilePage {
...
@ViewChild(Content) content: Content;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			CankerSoreInfographicsMobilePage, // 1
  		];
  ...
  togglePage(ind: number) {
  	if (ind == 31)
  	{
	  	...
	  	if (this.symptoms[8] == true)
	  		this.mode = 1;
	  	else if (this.symptoms[5] == true)
	  		this.mode = 2;
	  	else if (this.symptoms[7] == true)
	  		this.mode = 3;
	  	else if (trueCount > 0)
	  		this.mode = 4;
	  	else{
