...
import { ChestCongestionInfographicsMobilePage } from '../chest-congestion-infographics-mobile/chest-congestion-infographics-mobile';

@Component({
  selector: 'page-chest-congestion-mobile',
  templateUrl: 'chest-congestion-mobile.html'
})
export class ChestCongestionMobilePage {
...
@ViewChild(Content) content: Content;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			ChestCongestionInfographicsMobilePage,	// 1
  		];
