...
import { RashInfographicsMobilePage } from '../rash-infographics-mobile/rash-infographics-mobile';
...
export class RashMobilePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			ShinglesMobilePage,			// 1
  			EczemaMobilePage,			// 2
  			RingwormMobilePage,			// 3
  			HivesMobilePage,			// 4
  			BitesMobilePage,			// 5
  			PoisonIvyMobilePage,		// 6
  			ScabiesMobilePage,			// 7
  			RashInfographicsMobilePage,	// 8
  		];
