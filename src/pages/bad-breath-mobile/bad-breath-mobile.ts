...
import { BadBreathInfographicsMobilePage } from '../bad-breath-infographics-mobile/bad-breath-infographics-mobile';

@Component({
  selector: 'page-bad-breath-mobile',
  templateUrl: 'bad-breath-mobile.html'
})
export class BadBreathMobilePage {
...
@ViewChild(Content) content: Content;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			NearestPage,				// 1
  			BadBreathInfographicsMobilePage,	// 2
  		];
