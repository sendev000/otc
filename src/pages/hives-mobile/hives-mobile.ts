...
import { HivesInfographicsMobilePage } from '../hives-infographics-mobile/hives-infographics-mobile';
import { BitesMobilePage } from '../bites-mobile/bites-mobile';

@Component({
  selector: 'page-hives-mobile',
  templateUrl: 'hives-mobile.html'
})
export class HivesMobilePage {
