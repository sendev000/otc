...
import { FoodPoisoningInfographicsMobilePage } from '../food-poisoning-infographics-mobile/food-poisoning-infographics-mobile';

@Component({
  selector: 'page-food-poisoning-mobile',
  templateUrl: 'food-poisoning-mobile.html'
})
export class FoodPoisoningMobilePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			FoodPoisoningInfographicsMobilePage,	// 1
  		];
