...
import { IngrownNailInfographicsMobilePage } from '../ingrown-nail-infographics-mobile/ingrown-nail-infographics-mobile';
...
export class IngrownNailMobilePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			NailFungusMobilePage,		// 1
  			IngrownNailInfographicsMobilePage,	// 2
  		];
