...
import { CommentCompareGreenPage } from '../comment-compare-green/comment-compare-green';

@Component({
  selector: 'page-laxatives',
  templateUrl: 'laxatives.html'
})
export class LaxativesPage {
  ...
  showCommentCompare () {
    this.navCtrl.push(CommentCompareGreenPage);
  }
  showMenu() {
    this.menu.open();
  }
  ...
  initData() {
    ...
    this.RestApiURL = GlobalVars.getApiURL() + "page=laxatives";
    this.searchText = "";
    this.TableData = [];
    this.TableTempData = [];
