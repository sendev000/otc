...
import { MotionSicknessInfographicsMobilePage } from '../motion-sickness-infographics-mobile/motion-sickness-infographics-mobile';
...
@ViewChild(Content) content: Content;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			MotionAdultRecomMobilePage,	// 1
  			NearestPage,				// 2
  			MotionSicknessInfographicsMobilePage,	// 3
  		];
