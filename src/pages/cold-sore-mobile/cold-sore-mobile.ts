...
import { ColdSoreInfographicsMobilePage } from '../cold-sore-infographics-mobile/cold-sore-infographics-mobile';
...
@ViewChild(Content) content: Content;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			ColdSoreInfographicsMobilePage,	// 1
  		];
  	...
  	if (ind == 21)
  	{
	  	...
	  	for (let i=0;i<this.symptoms.length-1;i++)
	  		if (this.symptoms[i] == true)
	  			trueCount ++;
	  	if (this.symptoms[7] == true)
	  		this.mode = 1;
	  	else if (this.symptoms[6] == true)
	  		this.mode = 2;
	  	else if (trueCount > 0)
	  		this.mode = 3;
	  	else{
