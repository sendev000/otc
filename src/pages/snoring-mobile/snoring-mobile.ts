...
import { SnoringInfographicsMobilePage } from '../snoring-infographics-mobile/snoring-infographics-mobile';
...
@ViewChild(Content) content: Content;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			SnoringInfographicsMobilePage,	// 1
  		];
