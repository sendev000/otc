...
import { StomachFluInfographicsMobilePage } from '../stomach-flu-infographics-mobile/stomach-flu-infographics-mobile';
...
export class StomachFluMobilePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			StomachFluInfographicsMobilePage,	// 1
  		];
