...
import { CommentComparePinkPage } from '../comment-compare-pink/comment-compare-pink';
...
export class ProbioticsPage {
  ...
  showCommentCompare () {
    this.navCtrl.push(CommentComparePinkPage);
  }
  showMenu() {
    this.menu.open();
  }
  ...
  initData() {
    ...
    this.RestApiURL = GlobalVars.getApiURL() + "page=probiotics";
    this.searchText = "";
    this.TableData = [];
    this.TableTempData = [];
