...
import { BitesInfographicsMobilePage } from '../bites-infographics-mobile/bites-infographics-mobile';

@Component({
  selector: 'page-bites-mobile',
  templateUrl: 'bites-mobile.html'
})
export class BitesMobilePage {
