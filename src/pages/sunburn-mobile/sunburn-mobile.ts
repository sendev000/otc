...
import { SunburnInfographicsMobilePage } from '../sunburn-infographics-mobile/sunburn-infographics-mobile';

@Component({
  selector: 'page-sunburn-mobile',
  templateUrl: 'sunburn-mobile.html'
})
export class SunburnMobilePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			SunburnInfographicsMobilePage,	// 1
  		];
