...
import { DiarrheaInfographicsMobilePage } from '../diarrhea-infographics-mobile/diarrhea-infographics-mobile';
...
export class DiarrheaMobilePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			...
  			DiarrheaInfographicsMobilePage,	// 2
  		];
