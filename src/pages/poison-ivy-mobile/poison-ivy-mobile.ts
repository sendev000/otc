...
import { PoisonIvyInfographicsMobilePage } from '../poison-ivy-infographics-mobile/poison-ivy-infographics-mobile';
...
export class PoisonIvyMobilePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			PoisonIvyInfographicsMobilePage,	// 1
  		];
