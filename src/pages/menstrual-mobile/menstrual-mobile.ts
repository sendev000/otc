...
import { MenstrualInfographicsMobilePage } from '../menstrual-infographics-mobile/menstrual-infographics-mobile';

@Component({
  selector: 'page-menstrual-mobile',
  templateUrl: 'menstrual-mobile.html'
})
export class MenstrualMobilePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			MenstrualInfographicsMobilePage,	// 1
  		];
