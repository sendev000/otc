...
import { ToothacheInfographicsMobilePage } from '../toothache-infographics-mobile/toothache-infographics-mobile';
...
@ViewChild(Content) content: Content;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public platform: Platform) {
  	...
  	this.mode = 0;
  	this.mode2 = 0;
  	this.currentToothache = 0;	// default;
  	this.currentDay  = 0;
  	this.symptoms = [
  	...
  	this.subPages = [
  			UrgentCarePage, 			// 0
  			ToothacheInfographicsMobilePage,	// 1
  		];
