...
import { CommentCompareOrangePage } from '../comment-compare-orange/comment-compare-orange';
...
export class EnergyDrinksPage {
  ...
  showCommentCompare () {
    this.navCtrl.push(CommentCompareOrangePage);
  }
  showMenu() {
    this.menu.open();
  }
  ...
  initData() {
    ...
    this.RestApiURL = GlobalVars.getApiURL() + "page=energy_drinks";
    this.searchText = "";
    this.TableData = [];
    this.TableTempData = [];
